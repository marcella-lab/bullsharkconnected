...
export interface YardageRow { id: string; status: YardageStatus; state: string; concreteCompany: string; client: string; projectId?: string; dimensions: string; thickness: number; secondaryDimensions: string; secondaryThickness: number; secondarySectionType: "inside" | "additional"; secondarySquareFeet: number; secondaryAreaYardage: number; thirdDimensions: string; thirdThickness: number; thirdSectionType: "inside" | "additional"; thirdSquareFeet: number; thirdAreaYardage: number; thirdFooters: string; thirdFooterYardage: number; thirdAdditionalConcreteYardage: number; noPourDimensions: string; noPourThickness: number; noPourSquareFeet: number; netMainSquareFeet: number; totalCoveredSlabSquareFeet: number; mainSlabYardage: number; keepFooterAroundNoPour: boolean; footers: string; length: number; width: number; footerWidth: number; footerDepth: number; additionalFooterDepth: number; slabSquareFeet: number; slabYardage: number; footerYardage: number; totalYardage: number; additionalConcreteYardage: number; wastePercent: number; wasteOverageYardage: number; finalOrderYardage: number; recommendedOrderYardage: number; /* retained for existing saved rows */ padYardage?: number; concreteCost: number; subCost: number; contractCost: number; additionalCosts: number; notes?: string; createdAt: string; updatedAt: string; createdBy: string; updatedBy: string; }
